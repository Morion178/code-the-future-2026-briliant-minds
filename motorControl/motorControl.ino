...
void loop() {
  if (Serial.available() > 0) {
    ...
    if (k == 's' || k == 'S') {
        currentSpeed -= (decSpeed * 5);
    }
    if (k == 'h' || k == 'H') {
      Serial.print("HOOOOOOOOOONK");
    }
    int oldGear = gear;
    ...
    if (oldGear != gear) {
       switch (gear) {
          case 1: minSpeed = 0; maxSpeed = 50; break;
          case 2: minSpeed = 30; maxSpeed = 80; break;
          case 3: minSpeed = 60; maxSpeed = 110; break;
          case 4: minSpeed = 90; maxSpeed = 170; break;
          case 5: minSpeed = 100; maxSpeed = 230; break;
       }
    }
  }
