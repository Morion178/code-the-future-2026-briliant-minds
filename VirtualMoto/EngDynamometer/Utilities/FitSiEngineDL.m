function [neuralODE,airflowerror,torqueerror,maperror,egterror,EngineType]=FitSiEngineDL(varargin)
    ...
    options.ValidationPatience = inf; % how many validation loss increases before terminate the training
...
function PlotDoE(EngineDataTable,EngineType,Validation_data_pct)
    ...
    Data=table2array(EngineDataTable);
    ...
    set(h,'Name','Overlay of Test vs Train Steady-State Input Targets','NumberTitle','off');
...
function [usim,ysim,yhatsim,airflowerror,torqueerror,maperror,egterror]=ValidateODENN(EngInputs,EngOutputs,Ts,EngineType,neuralODE,options,fparent)
    ...
    h3=figure;
    set(h3,'Name','Test Responses','NumberTitle','off');
    ax3(1)=subplot(4,1,1);
    ...
    h4=figure;
    set(h4,'Name','Model Test Results','NumberTitle','off');
    subplot(2,2,1)
