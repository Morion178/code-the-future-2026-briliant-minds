...
#define S_FUNCTION_NAME PRNDLController_msf
#endif
...
rtP__TireFrntWhlRadius2f2MotoWheel_sldd_ ; real_T
rtP__TireRearWhlRadius2f2MotoWheel_sldd_ ; const char *
...
static void mdlProcessParameters ( SimStruct * S ) { real_T * GlobalPrm_0 = ( real_T * ) NULL ; real_T * GlobalPrm_1 = ( real_T * ) NULL ; real_T * GlobalPrm_2 = ( real_T * ) NULL ; real_T * GlobalPrm_3 = ( real_T * ) NULL ; if ( ! ssGetModelRefGlobalParamData ( S , 0 , ( void * * ) ( & GlobalPrm_0 ) ) ) return ; if ( GlobalPrm_0 != NULL ) { ( void ) memcpy ( & ( rtP__CtrlTcuDnLdBpt2f2Drivetrain_sldd_ [ 0 ] ) , GlobalPrm_0 , sizeof ( real_T ) * 4 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 1 , ( void * * ) ( & GlobalPrm_1 ) ) ) return ; if ( GlobalPrm_1 != NULL ) { ( void ) memcpy ( & ( rtP__CtrlTcuUpLdBpt2f2Drivetrain_sldd_ [ 0 ] ) , GlobalPrm_1 , sizeof ( real_T ) * 4 ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 2 , ( void * * ) ( & GlobalPrm_2 ) ) ) return ; if ( GlobalPrm_2 != NULL ) { ( void ) memcpy ( & ( rtP__TireFrntWhlRadius2f2MotoWheel_sldd_ ) , GlobalPrm_2 , sizeof ( real_T ) ) ; } if ( ! ssGetModelRefGlobalParamData ( S , 3 , ( void * * ) ( & GlobalPrm_3 ) ) ) return ; if ( GlobalPrm_3 != NULL ) { ( void ) memcpy ( & ( rtP__TireRearWhlRadius2f2MotoWheel_sldd_ ) , GlobalPrm_3 , sizeof ( real_T ) ) ; } }
#endif
static void mdlInitializeConditions ( SimStruct * S ) { co0xztiide0 * dw = ( co0xztiide0 * ) ssGetDWork ( S , 0 ) ; real_T * o_o_o_B_5_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; pyx05adf24 ( o_o_o_B_5_1 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } static void mdlReset ( SimStruct * S ) { co0xztiide0 * dw = ( co0xztiide0 * ) ssGetDWork ( S , 0 ) ; real_T * o_o_o_B_5_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; bd4kosf0po ( o_o_o_B_5_1 , & ( dw -> rtdw ) ) ; } static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { co0xztiide0 * dw = ( co0xztiide0 * ) ssGetDWork ( S , 0 ) ; real_T const * i_h2ze4qirdx = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const * i_msh2hvnrzx = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const * i_je1t43uii4 = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T const * i_lucc1rk3ex = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T const * i_np2c501s1b = ( real_T * ) ssGetInputPortSignal ( S , 4 ) ; boolean_T const * i_cdgn42ef0v = ( boolean_T * ) ssGetInputPortSignal ( S , 5 ) ; real_T * o_o_o_B_5_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; if ( tid == 0 ) { PRNDLController ( i_h2ze4qirdx , i_msh2hvnrzx , i_je1t43uii4 , i_lucc1rk3ex , i_np2c501s1b , i_cdgn42ef0v , o_o_o_B_5_1 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } } static void mdlInitializeSizes ( SimStruct * S ) { if ( ( S -> mdlInfo -> genericFcn != ( NULL ) ) && ( ! ( S -> mdlInfo -> genericFcn ) ( S , GEN_FCN_CHK_MODELREF_SFUN_HAS_MODEL_BLOCK , - 1 , ( NULL ) ) ) ) { return ; } ssSetNumSFcnParams ( S , 0 ) ; ssFxpSetU32BitRegionCompliant ( S , 1 ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } ssSetRTWGeneratedSFcn ( S , 2 ) ; ssSetNumContStates ( S , 0 ) ; ssSetNumDiscStates ( S , 0 ) ; ssSetSymbolicDimsSupport ( S , true ) ; slmrInitializeIOPortDataVectors ( S , 6 , 1 ) ; if ( ! ssSetNumInputPorts ( S , 6 ) ) return ; if ( ! ssSetInputPortVectorDimension ( S , 0 , 1 ) ) return ; ssSetInputPortDimensionsMode ( S , 0 , FIXED_DIMS_MODE ) ; ssSetInputPortFrameData ( S , 0 , FRAME_NO ) ; if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) { ssSetInputPortDataType ( S , 0 , SS_DOUBLE ) ; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
...
ssSetInputPortVectorDimension ( S , 2 , 2 ) ) return ;
...
ssSetInputPortVectorDimension ( S , 5 , 2 ) ) return ;
...
mr_PRNDLController_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S ,
...
mr_PRNDLController_MdlInfoRegFcn ( S , "PRNDLController" , & retVal ) ; if ( !
retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
...
( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( co0xztiide0 ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { co0xztiide0 * dw = ( co0xztiide0 * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } adgpgs52hf ( S , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 1 , true ) , & ( dw -> rtm ) , & ( dw -> rtb ) , & ( dw -> rtdw ) , sysRanPtr , sysTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & ( dw -> rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { mdlProcessParameters ( S ) ; }
static void mdlOutputs ( SimStruct * S , int_T tid ) { co0xztiide0 * dw = ( co0xztiide0 * ) ssGetDWork ( S , 0 ) ; real_T const * i_h2ze4qirdx = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const * i_msh2hvnrzx = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const * i_je1t43uii4 = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T const * i_lucc1rk3ex = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T const * i_np2c501s1b = ( real_T * ) ssGetInputPortSignal ( S , 4 ) ; boolean_T const * i_cdgn42ef0v = ( boolean_T * ) ssGetInputPortSignal ( S , 5 ) ; real_T * o_o_o_B_5_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; if ( tid == PARAMETER_TUNING_TID ) { } if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { PRNDLController ( i_h2ze4qirdx , i_msh2hvnrzx , i_je1t43uii4 , i_lucc1rk3ex , i_np2c501s1b , i_cdgn42ef0v , o_o_o_B_5_1 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } } static void mdlTerminate ( SimStruct * S ) { co0xztiide0 * dw = ( co0xztiide0 * ) ssGetDWork ( S , 0 ) ; iaqi3xc5te ( & ( dw -> rtm ) ) ; return ; }
...
mdlrefDW = mr_PRNDLController_GetDWork ( ssGetDWork ( S , 0 ) ) ;
mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_PRNDLController_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss
...
mr_PRNDLController_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber ( ss
