...
MODEL                   = PRNDLController
MODULES                 = PRNDLController_msf.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\PRNDLController_msf.mexw64
MAKEFILE                = PRNDLController.mk
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:PRNDLController_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
MODELLIB                  = PRNDLController_msf.mexw64
MODELREF_LINK_LIBS        = C:\Users\Omen\Desktop\TemeFac\AN2\SiemensHackaton\VirtualMoto\VirtualMoto\Work\slprj\sim\PRNDLController\PRNDLControllerlib.lib
MODELREF_LINK_RSPFILE     = PRNDLController_ref.rsp
COMPILER_COMMAND_FILE     = PRNDLController_comp.rsp
...
PRNDLController_msf.obj : $(START_DIR)\slprj\sim\PRNDLController\PRNDLController_msf.c
	@cmd /C echo ### Compiling "$(START_DIR)\slprj\sim\PRNDLController\PRNDLController_msf.c"
	$(CC) $(CFLAGS) $(START_DIR)\slprj\sim\PRNDLController\PRNDLController_msf.c
