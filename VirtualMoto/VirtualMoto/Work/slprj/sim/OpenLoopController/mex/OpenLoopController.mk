...
MODEL                   = OpenLoopController
MODULES                 = OpenLoopController_msf.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\OpenLoopController_msf.mexw64
MAKEFILE                = OpenLoopController.mk
MATLAB_ROOT             = C:\Program Files\MATLAB\R2025b
ALT_MATLAB_ROOT         = C:\PROGRA~1\MATLAB\R2025b
START_DIR               = C:\Users\Omen\Desktop\TemeFac\AN2\SiemensHackaton\VirtualMoto\VirtualMoto\Work
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:OpenLoopController_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
MODELLIB                  = OpenLoopController_msf.mexw64
MODELREF_LINK_LIBS        = C:\Users\Omen\Desktop\TemeFac\AN2\SiemensHackaton\VirtualMoto\VirtualMoto\Work\slprj\sim\OpenLoopController\OpenLoopControllerlib.lib
MODELREF_LINK_RSPFILE     = OpenLoopController_ref.rsp
COMPILER_COMMAND_FILE     = OpenLoopController_comp.rsp
...
OpenLoopController_msf.obj : $(START_DIR)\slprj\sim\OpenLoopController\OpenLoopController_msf.c
	@cmd /C echo ### Compiling "$(START_DIR)\slprj\sim\OpenLoopController\OpenLoopController_msf.c"
	$(CC) $(CFLAGS) $(START_DIR)\slprj\sim\OpenLoopController\OpenLoopController_msf.c
