...
ssSetInputPortOffsetTime ( S , 1 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 3
...
mr_NoVCU_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S , 2 ) ;
...
o_B_1_2 = ( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_1_3 = ( real_T * ) ssGetOutputPortSignal ( S , 2 ) ; if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { NoVCU ( & ( dw -> rtm ) , i_cvuiryx1yh , i_pglazlbjbt , o_B_1_1 , o_B_1_2 , o_B_1_3 ) ; } } static void mdlTerminate ( SimStruct * S ) { iehsp021cqq * dw = ( iehsp021cqq * ) ssGetDWork ( S , 0 ) ; cfmi0pqnbo ( & ( dw -> rtm ) ) ; return ; }
