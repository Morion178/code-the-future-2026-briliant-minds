...
MODEL                   = NoVCU
MODULES                 = NoVCU_msf.c c_mexapi_version.c
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:NoVCU_msf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
MODELLIB                  = NoVCU_msf.mexw64
MODELREF_LINK_LIBS        = C:\Users\Omen\Desktop\TemeFac\AN2\SiemensHackaton\VirtualMoto\VirtualMoto\Work\slprj\sim\NoVCU\NoVCUlib.lib
...
NoVCU_msf.obj : $(START_DIR)\slprj\sim\NoVCU\NoVCU_msf.c
	@cmd /C echo ### Compiling "$(START_DIR)\slprj\sim\NoVCU\NoVCU_msf.c"
	$(CC) $(CFLAGS) $(START_DIR)\slprj\sim\NoVCU\NoVCU_msf.c
